...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i639.AuthInteractor>(
        () => _i639.AuthInteractor(gh<_i582.AuthRepository>()));
    gh.lazySingleton<_i296.AuthInterceptor>(
        () => _i296.AuthInterceptor(gh<_i639.AuthInteractor>()));
    gh.lazySingleton<_i938.StudentApiService>(() => _i938.StudentApiService(
          gh<_i970.DioProvider>(),
          gh<_i676.LogService>(),
          gh<_i50.SelectedSchoolInteractor>(),
          gh<_i296.AuthInterceptor>(),
        ));
